...
- **Sliding Window Entropy Scanning**: Efficiently scan millions of base pairs
to find regions with unusual codon usage patterns
...
- **Reference Profile Creation**: Build organism-specific codon usage profiles
from known genes
