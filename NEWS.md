...
NEW FEATURES
  ...
  * Added extract_known_genes() for extracting genes from GTF/GFF annotations
  * Added create_reference_profile() for building organism-specific profiles
